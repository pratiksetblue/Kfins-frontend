...
<section class="contact-section-four bg-img jarallax" style="background-image: url('/assets/img/from_bg.jpg');">
...
<h2 class="text-white fadeInUp" data-delay="0.2">Let’s Build the Right <br/>Solution for You</h2>
</div>
