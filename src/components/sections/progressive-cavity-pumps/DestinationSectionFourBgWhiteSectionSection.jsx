...
export default function DestinationSectionFourBgWhiteSectionSection() {
  return <div className="section-component section-destinationfourbgwhite" dangerouslySetInnerHTML={{ __html: `
<section class="destination-section-four bg-white">
